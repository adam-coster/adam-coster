...
tags:
  ...
  - recipe
recipe:
  name: Super Simple Cold Brew Coffee
  description: All you need is a jar, a tea infuser, and some ground coffee.
  image: https://adamcoster.com/images/coffee/coffee-infusion.jpg
  recipeIngredient:
  ...
  recipeInstructions:
    - "@type": HowToStep
      text: Grind coffee beans coarsely and add to the tea infuser.
    - "@type": HowToStep
      text: Place the tea infuser into a mason jar.
    - "@type": HowToStep
      text: Pour room temperature or colder water over the coffee, refilling
        periodically as it passes through the grounds, until it is close to the
        top.
    - "@type": HowToStep
      text: Cover, place in the refrigerator, and let sit for 18+ hours.
---

Cold brew coffee is great, especially for things like [coffee tonics](/blog/coffee-tonic) where you want to let other flavors shine. There are lots of ways you could go about making cold brew -- like with any other kind of coffee we're just playing with variations on the following:
...
I use pint or quart mason jar, and an appropriately-sized tea infuser ([for 1 pint](https://www.amazon.com/gp/product/B01LQ7NQTW/), [for 1 quart](https://www.amazon.com/gp/product/B075L531TR/)).
